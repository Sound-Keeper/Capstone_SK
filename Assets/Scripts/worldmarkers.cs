...
public class worldmarkers : MonoBehaviour
{
    ...
    static readonly Vector3 Plaza      = new Vector3(75,  0, 75);
    static readonly Vector3 Archmage   = new Vector3(75,  0, 45);
    static readonly Vector3 Police     = new Vector3(101, 0, 50);
    static readonly Vector3 Judge      = new Vector3(105, 0, 75);
    static readonly Vector3 Playground = new Vector3(75,  0, 105);
    static readonly Vector3 Grandma    = new Vector3(45,  0, 100);
    static readonly Vector3 Library    = new Vector3(45,  0, 75);
